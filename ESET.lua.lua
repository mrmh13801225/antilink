...
day = 313456502
--*********BOT ID*******--
bot_id = 313456502 -- [[محل قرار گیری آیدی اکانت ربات]]
--**********************--
--*********SUDO ID*******--
sudo_users = {190826345,259080698,350459212,118097100,273951509,374907521} -- [[محل قرار گیری آیدی سودو ها]]
--***********************--
--********BOT OWNER******--
bot_owner = 259080698 -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
      ...
      if database:get('bot:cmds'..msg.chat_id_) and not is_momod(msg.sender_user_id_, msg.chat_id_) then
        ...
        if text:match("^[Pp]romote (%d+)$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
          ...
          if database:get('lang:gp:'..msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, '🍀 کاربر با شناسه : '..ap[2]..' به مدیریت گپ انتخاب شد !', 1, 'md')
          end
        ...
        if text:match("^[Gg]p id$") or text:match("^شناسه گروه$") then
          if database:get('lang:gp:'..msg.chat_id_) then
            ...
            texts = "💎 ایدی عددی گپ : "..msg.chat_id_
          end
          send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
        end
        -----------------------------------------------------------------------------------------------
          ...
          if text:match("^[Bb]an$") and msg.reply_to_message_id_ ~= 0 then
            function ban_by_reply(extra, result, success)
              ...
              if not is_momod(result.sender_user_id_, result.chat_id_) then
                if database:sismember(hash, result.sender_user_id_) then
                  if database:get('lang:gp:'..msg.chat_id_) then
                    send(msg.chat_id_, msg.id_, 1, '✅ User : '..result.sender_user_id_..' is already banned !\n▪️ Our Channel: @botreborn', 1, 'md')
                  else
                    send(msg.chat_id_, msg.id_, 1, '✅ کاربر با شناسه : '..result.sender_user_id_..' هم اکنون مسدود است !\n▪️ Our Channel: @botreborn', 1, 'md')
                  end
                  chat_kick(result.chat_id_, result.sender_user_id_)
                else
                  database:sadd(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
                    send(msg.chat_id_, msg.id_, 1, '✅ User : '..result.sender_user_id_..' has been banned !\n▪️ Our Channel: @botreborn', 1, 'md')
                  else
                    send(msg.chat_id_, msg.id_, 1, '✅ کاربر با شناسه : '..result.sender_user_id_..' مسدود گردید !\n▪️ Our Channel: @botreborn', 1, 'md')
                  end
                  chat_kick(result.chat_id_, result.sender_user_id_)
                end
              end
            ...
            local function getproen(extra, result, success)
              if database:get('getidstatus'..msg.chat_id_) == "Photo" then
                if result.photos_[0] then
                  if database:get('lang:gp:'..msg.chat_id_) then
                    sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,'▪️ Your ID : '..msg.sender_user_id_..'\n▪️ Our Channel: @botreborn \n▪️ Number of messages : '..user_msgs,msg.id_,msg.id_)
                  else
                    sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,'▪️ شناسه شما :  '..msg.sender_user_id_..'\n▪️ کانال ما: @botreborn \n▪️ تعداد پیام های ارسالی شما : '..user_msgs,msg.id_,msg.id_)
                  end
                else
                  if database:get('lang:gp:'..msg.chat_id_) then
                    send(msg.chat_id_, msg.id_, 1, "> You don't have profile photo !\n\n▪️ Your ID : "..msg.sender_user_id_.."\n▪️ Our Channel: @botreborn \n▪️ Number of messages  : "..user_msgs, 1, 'md')
                  else
                    send(msg.chat_id_, msg.id_, 1, "> شما عکس پروفایل ندارید !\n\n▪️ شناسه شما : "..msg.sender_user_id_.."\n▪️ کانال ما: @botreborn \n▪️ تعداد پیام های ارسالی شما : "..user_msgs, 1, 'md')
                  end
                end
              end
              if database:get('getidstatus'..msg.chat_id_) == "Simple" then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "▪️ Your ID : "..msg.sender_user_id_.."\n▪️ Our Channel: @botreborn \n▪️ Number of messages : "..user_msgs, 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, "▪️ شناسه شما : "..msg.sender_user_id_.."\n▪️ کانال ما: @botreborn \n▪️ تعداد پیام های ارسالی شما : "..user_msgs, 1, 'md')
                end
              end
        ...
        if text:match("^[Ss]etlang (.*)$") or text:match("^تنظیم زبان (.*)$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
          ...
          if langs[2] == "fa" or langs[2] == "فارسی" then
            if not database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '◾️ زبان ربات هم اکنون بر روی فارسی قرار دارد !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '◾️ زبان ربات به فارسی تغییر پیدا کرد !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
              database:del('lang:gp:'..msg.chat_id_)
            end
          end
          if langs[2] == "en" or langs[2] == "انگلیسی" then
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '◽️ *Language Bot is already English*\n▪ Our Channel: @botreborn', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '◽️ *Language Bot has been changed to English*\n▪ Our Channel: @botreborn', 1, 'md')
          ...
          if text:match("^[Uu]nlock (.*)$") or text:match("^بازکردن (.*)$") then
            ...
            if unlockpt[2] == "edit" or unlockpts[2] == "ویرایش پیام" then
              if database:get('editmsg'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* *Lock edit has been inactive*\n👁‍🗨کانال ما: @botreborn !', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ویرایش پیام #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('editmsg'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock edit is *already* inactive !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ویرایش پیام از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unlockpt[2] == "cmd" or unlockpts[2] == "حالت عدم جواب" then
              if database:get('bot:cmds'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Case of no answer has been *inactive* !', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* حالت عدم جواب #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:cmds'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Case of no answer is *already* inactive !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> حالت عدم جواب از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unlockpt[2] == "bots" or unlockpts[2] == "ربات" then
              if database:get('bot:bots:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock bot has been *inactive* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ورود ربات #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:bots:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock bots is *already* inactive !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ورود ربات از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unlockpt[2] == "flood" or unlockpts[2] == "فلود" then
              if database:get('anti-flood:'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, ' Lock flood has been *inactive* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فلود #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('anti-flood:'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock flood is *already* inactive !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل قلود از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unlockpt[2] == "pin" or unlockpts[2] == "سنجاق پیام" then
              if database:get('bot:pin:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "🔸*F80*Lock pin has been *inactive* !\n👁‍🗨کانال ما: @botreborn ", 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, "🔸*F80* قفل سنجاق پیام #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ", 1, 'md')
                end
                database:del('bot:pin:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "🔸*F80* Lock pin is *already* inactive !\n👁‍🗨کانال ما: @botreborn", 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, "🔸*F80* قفل سنجاق پیام از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ", 1, 'md')
                end
              end
            end
          end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          ...
          if text:match("^قفل جی تایم (%d+)$") then
            ...
            database:setex('bot:muteall'..msg.chat_id_, num, true)
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "🔸*F80* Lock all has been enable for "..mutept[1].." hours !", 'md')
            else
              send(msg.chat_id_, msg.id_, 1, "🔸*F80* قفل گروه [ همه چیز ] به مدت "..mutept[1].." ساعت #فعال شد !", 'md')
            end
          end
        end
        -----------------------------------------------------------------------------------------------
          ...
          if text:match("^[Ll]ock (.*)$") or text:match("^قفل (.*)$") then
            ...
            if mutept[2] == "all" or  mutepts[2] == "گروه" then
              if not database:get('bot:muteall'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock all has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گروه [ همه چیز ] #فعال شد !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
                database:set('bot:muteall'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock all is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گروه [ همه چیز ] از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "text" or mutepts[2] == "متن" then
              if not database:get('bot:text:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '> Lock text has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock text is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل متن [ چت ] از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "inline" or mutepts[2] == "دکمه شیشه ای" then
              if not database:get('bot:inline:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock inline has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل دکمه شیشه ایی #فعال شد !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
                database:set('bot:inline:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock inline is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل دکمه شیشه ایی از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "photo" or mutepts[2] == "عکس" then
              if not database:get('bot:photo:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock photo has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل عکس #فعال شد !', 1, 'md')
                end
                database:set('bot:photo:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock photo is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل عکس از قبل #فعال است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "spam" or mutepts[2] == "اسپم" then
              if not database:get('bot:spam:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock spam has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل اسپم #فعال شد !', 1, 'md')
                end
                database:set('bot:spam:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock spam is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل اسپم از قبل #فعال است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "video" or mutepts[2] == "فیلم" then
              if not database:get('bot:video:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock video has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فیلم #فعال شد !', 1, 'md')
                end
                database:set('bot:video:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock video is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فیلم از قبل #فعال است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "gif" or mutepts[2] == "گیف" then
              if not database:get('bot:gifs:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock gif has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گیف #فعال شد !', 1, 'md')
                end
                database:set('bot:gifs:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock gif is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گیف از قبل #فعال است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "music" or mutepts[2] == "موزیک" then
              if not database:get('bot:music:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock music has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موزیک #فعال شد !', 1, 'md')
                end
                database:set('bot:music:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock music is *alraedy* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موزیک از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "voice" or mutepts[2] == "ویس" then
              if not database:get('bot:voice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock voice has been actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ویس #فعال شد !', 1, 'md')
                end
                database:set('bot:voice:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock voice is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
            ...
            if mutept[2] == "links" or mutepts[2] == "لینک" then
              if not database:get('bot:links:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock links has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل لینک #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:links:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock links is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل لینک از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "location" or mutepts[2] == "موقعیت مکانی" then
              if not database:get('bot:location:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock location has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موقعیت مکانی #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:location:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock location is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موقعیت مکانی از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "tag" or mutepts[2] == "تگ" then
              if not database:get('tags:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tag has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل تگ #فعال شد ! ', 1, 'md')
                end
                database:set('tags:lock'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tag is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل تگ از قبل #فعال است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "strict" or  mutepts[2] == "حالت سختگیرانه" then
              if not database:get('bot:strict'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Strict mode has been *enable* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*حالت [ سختگیرانه ] #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:strict'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Strict mode is *already* enable !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* حالت [ سختگیرانه ] از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if mutept[2] == "file" or mutepts[2] == "فایل" then
              if not database:get('bot:document:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock file has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فایل #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:document:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock file is *already* actived  !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فایل از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "hashtag" or mutepts[2] == "هشتگ" then
              if not database:get('bot:hashtag:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock hastag has been actived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل هشتگ #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:hashtag:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock hashtag is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل هشتگ از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "contact" or mutepts[2] == "مخاطب" then
              if not database:get('bot:contact:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock contact has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ارسال مخاطب #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:contact:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock contact is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل ارسال مخاطب از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "webpage" or mutepts[2] == "صفحات اینترنتی" then
              if not database:get('bot:webpage:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock webpage has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ارسال صفحه اینترنتی #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:webpage:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock webpage is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ارسال صفحه اینترنتی از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "farsi" or mutepts[2] == "نوشتار فارسی" then
              if not database:get('bot:arabic:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock farsi has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار فارسی #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:arabic:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock farsi is *already* actived', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار فارسی از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "english" or mutepts[2] == "نوشتار انگلیسی" then
              if not database:get('bot:english:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock english has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار انگلیسی #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:english:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock english is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار انگلیسی از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "sticker" or mutepts[2] == "استیکر" then
              if not database:get('bot:sticker:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock sticker has been *actived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل استیکر #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:sticker:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock sticker is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل استیکر از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "markdown" or mutepts[2] == "مدل نشانه گذاری" then
              if not database:get('markdown:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock markdown has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل مدل نشانه گذاری #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('markdown:lock'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock markdown is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل مدل نشانه گذاری از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "tgservice" or mutepts[2] == "سرویس تلگرام" then
              if not database:get('bot:tgservice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tgservice has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل سرویس تلگرام #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:tgservice:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tgservice is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل سرویس تلگرام از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
            if mutept[2] == "fwd" or mutepts[2] == "فروارد" then
              if not database:get('bot:forward:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock forward has been *actived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل فروارد #فعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:set('bot:forward:mute'..msg.chat_id_,true)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock forward is *already* actived !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فروارد از قبل #فعال است !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
              end
            end
          end
          ...
          if text:match("^[Uu]nlock (.*)$") or text:match("^بازکردن (.*)$") then
            ...
            if unmutept[2] == "all" or unmutept[2] == "gtime" or unmutepts[2] == "گروه" then
              if database:get('bot:muteall'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock all has been *inactived* !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گروه [ همه چیز ] #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn', 1, 'md')
                end
                database:del('bot:muteall'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock all is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گروه [ همه چیز ] از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "text" or unmutepts[2] == "متن" then
              if database:get('bot:text:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock text has been *inactived* ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل متن [ چت ] #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:text:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock text is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل متن [ چت ] از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "photo" or unmutepts[2] == "عکس" then
              if database:get('bot:photo:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock photo has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل عکس #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:photo:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock photo is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل عکس از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "spam" or unmutepts[2] == "اسپم" then
              if database:get('bot:spam:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '> Lock spam has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل اسپم #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:spam:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock spam is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل اسپم از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "video" or unmutepts[2] == "فیلم" then
              if database:get('bot:video:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock video has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فیلم #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:video:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock video is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فیلم از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "file" or unmutepts[2] == "فایل" then
              if database:get('bot:document:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '> Lock file has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل فایل #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:document:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock file is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فایل از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "inline" or unmutepts[2] == "دکمه شیشه ای" then
              if database:get('bot:inline:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock inline has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل دکمه شیشه ایی #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:inline:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock inline is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل دکمه شیشه ایی از قبل #غیرفعال است ! ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "markdown" or unmutepts[2] == "مدل نشانه گذاری" then
              if database:get('markdown:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock markdown has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل مدل نشانه گذاری #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('markdown:lock'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock markdown is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل مدل نشانه گذاری از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "gif" or unmutepts[2] == "گیف" then
              if database:get('bot:gifs:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock gif has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل گیف #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:gifs:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, 'Lock gif is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> قفل گیف از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "music" or unmutepts[2] == "موزیک" then
              if database:get('bot:music:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock music has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موزیک #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:music:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock music is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل موزیک از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "voice" or unmutepts[2] == "ویس" then
              if database:get('bot:voice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock voice has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ویس #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:voice:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock voice is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ویس از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "links" or unmutepts[2] == "لینک" then
              if database:get('bot:links:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock links has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, ' 🔸*F80*قفل لینک #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:links:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock link is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل لینک از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "location" or unmutepts[2] == "موقعیت مکانی" then
              if database:get('bot:location:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock location has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل موقعیت مکانی #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:location:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock location is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل موقعیت مکانی از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "tag" or unmutepts[2] == "تگ" then
              if database:get('tags:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tag has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل تگ #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('tags:lock'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock tag is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل تگ از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "strict" or unmutepts[2] == "حالت سختگیرانه" then
              if database:get('bot:strict'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Strict mode has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* حالت [ سختگیرانه ] #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:strict'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Strict mode is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*حالت [ سختگیرانه ] از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "hashtag" or unmutepts[2] == "هشتگ" then
              if database:get('bot:hashtag:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock hashtag has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل ارسال مخاطب #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:hashtag:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock hashtag is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل هشتگ از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "contact" or unmutepts[2] == "مخاطب" then
              if database:get('bot:contact:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock contact has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل مخاطب #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:contact:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock contact is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, ' 🔸*F80* قفل ارسال مخاطب از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "webpage" or unmutepts[2] == "صفحات اینترنتی" then
              if database:get('bot:webpage:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock webpage has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل ارسال صفحه اینترنتی #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:webpage:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock webpage is *already* inactived ! \n👁‍🗨کانال ما: @botreborn', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*قفل ارسال صفحه اینترنتی از قبل #غیرفعال است !', 1, 'md')
                end
              end
            end
            if unmutept[2] == "farsi" or unmutepts[2] == "نوشتار فارسی" then
              if database:get('bot:arabic:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock farsi has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار فارسی #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:arabic:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock farsi is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار فارسی از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "english" or unmutepts[2] == "نوشتار انگلیسی" then
              if database:get('bot:english:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock english has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار انگلیسی #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:english:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock english is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل نوشتار انگلیسی از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "tgservice" or unmutepts[2] == "سرویس تلگرام" then
              if database:get('bot:tgservice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock tgservice has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل سرویس تلگرام #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:tgservice:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock tgservice is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل سرویس تلگرام از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "sticker" or unmutepts[2] == "استیکر" then
              if database:get('bot:sticker:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock sticker has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل استیکر #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:sticker:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock sticker is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل استیکر از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
            if unmutept[2] == "fwd" or unmutepts[2] == "فروارد" then
              if database:get('bot:forward:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* Lock forward has been *inactived* !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فروارد #غیرفعال شد !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
                database:del('bot:forward:mute'..msg.chat_id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80*Lock forward is *already* inactived !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '🔸*F80* قفل فروارد از قبل #غیرفعال است !\n👁‍🗨کانال ما: @botreborn ', 1, 'md')
                end
              end
            end
          end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          if text:match("^[Ss]ettings$") or text:match("^تنظیمات$") then
            ...
            .."◾️ حالت سختگیرانه : "..strict.."\n"
            .."◾️ حالت قفل کلی گروه : "..mute_all.."\n"
            .."◾️ حالت عدم جواب : "..mute_cmd.."\n\n"
            .."قفل ها:🔻 :\n\n"
            .."◾️ قفل اسپم : "..lock_spam.."\n"
            .."◾️ قفل لینک : "..mute_links.."\n"
            .."️◾️ قفل آدرس اینترنتی :  "..lock_wp.."\n"
            .."◾️ قفل تگ : "..lock_tag.."\n"
            .."◾️ قفل هشتگ : "..lock_htag.."\n"
            .."◾️ قفل فروارد : "..lock_forward.."\n"
            .."◾️ قفل ورود ربات :  "..mute_bots.."\n"
            .."️◾️ قفل ویرایش پیام :  "..mute_edit.."\n"
            .."️◾️ قفل سنجاق پیام : "..lock_pin.."\n"
            .."◾️ قفل دکمه شیشه ایی : "..mute_in.."\n"
            .."◾️ قفل نوشتار فارسی :  "..lock_arabic.."\n"
            .."◾️ قفل نوشتار انگلیسی : "..lock_english.."\n"
            .."◾️ قفل مدل نشانه گذاری : "..markdown.."\n"
            .."️◾️ قفل سرویس تلگرام : "..lock_tgservice.."\n"
            .."◾️ قفل فلود : "..mute_flood.."\n"
            .."◾️ وضعیت فلود : "..floodstatus.."\n"
            .."◾️ حساسیت فلود : [ "..flood_m.." ]\n"
            .."️◾️ حساسیت اسپم : [ "..spam_c.." ]\n\n"
            .." قفل رسانه ها⚠️ :\n\n"
            .."◽️ قفل متن [ چت ] : "..mute_text.."\n"
            .."◽️ قفل عکس : "..mute_photo.."\n"
            .."◽️ قفل فیلم : "..mute_video.."\n"
            .."◽️ قفل گیف : "..mute_gifs.."\n"
            .."◽️ قفل موزیک : "..mute_music.."\n"
            .."◽️ قفل ویس : "..mute_voice.."\n"
            .."◽️ قفل فایل : "..lock_file.."\n"
            .."◽️ قفل استیکر : "..lock_sticker.."\n"
            .."◽️ قفل ارسال مخاطب : "..lock_contact.."\n"
            .."️◽️ قفل موقعیت مکانی : "..lock_location.."\n"
        ...
        if text:match('^[Aa]dd$') and is_admin(msg.sender_user_id_, msg.chat_id_) then
          function adding(extra,result,success)
            ...
            if database:get("bot:enable:"..msg.chat_id_) then
              if not database:get('lang:gp:'..msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, '》 گروه از قبل در لیست مدیریتی ربات میباشد !\n➖➖➖➖\nکانال ربات:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
              else
                send(msg.chat_id_, msg.id_, 1, '》 This group is already in list management !\n➖➖➖➖\njoin:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
              end
            else
              if database:get('lang:gp:'..msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, '》 This group has been added to list management !\n➖➖➖➖\njoin:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
              else
                send(msg.chat_id_, msg.id_, 1, '》 گروه به لیست مدیریتی ربات اضافه شد !\n➖➖➖➖\nکانال ربات:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
              end
        ...
        if text:match('^[Rr]em$') and is_admin(msg.sender_user_id_, msg.chat_id_) then
          ...
          if not database:get("bot:enable:"..msg.chat_id_) then
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '> Group is not in list management !\n➖➖➖➖\njoin:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '> گروه در لیست مدیریتی ربات نیست !\n➖➖➖➖\nکانال ما:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
            end
          else
            if database:get('lang:gp:'..msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, '> Group has been removed from list management !\n➖➖➖➖\njoin:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
            else
              send(msg.chat_id_, msg.id_, 1, '> گروه از لیست مدیریتی ربات حذف شد !\n➖➖➖➖\nکانال ما:@botreborn\n👥در صورت هر گونه مشکل به سودو ها پیام بدید', 1, 'md')
            end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          ...
          if text:match("^اطلاعات (.*)$") then
            ...
            function whois(extra,result,success)
              if database:get('lang:gp:'..msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, '1⃣Name :'..result.first_name_..'\n2⃣ Username : @'..result.username_..'\n3⃣ID : '..msg.sender_user_id_, 1, 'html')
              else
                send(msg.chat_id_, msg.id_, 1, '1⃣نام کاربری : '..result.first_name_..'\n2⃣ایدی : @'..result.username_..'\n3⃣ایدی عددی : '..msg.sender_user_id_, 1, 'html')
              end
            end
            getUser(memb[2],whois)
          end
